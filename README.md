...
# Dotpulse.AccordionPages Package for Neos CMS #

## Composer

### Integration Repository
```
composer config repositories.button vcs ssh://hg@bitbucket.org/dotpulse/neos-plugin-accordion-pages
```

### Installation
```
composer require dotpulse/accordionpages
```
* * *
> ##### License Terms
